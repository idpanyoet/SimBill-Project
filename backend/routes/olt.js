...
router.post('/onu/gemport', (req, res) => {
  const b = req.body || {};
...
router.post('/onu/service', (req, res) => {
  const b = req.body || {};
...
router.post('/onu/onusvc', (req, res) => {
  const b = req.body || {};
